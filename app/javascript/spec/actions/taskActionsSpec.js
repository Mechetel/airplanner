...
describe("taskActions", () => {
  describe("createTask", () => {
    it("create new task asyncly", (done) => {
      ...
      fetchMock.postOnce("*", { id: 99, name: validTaskName, position: 99 }, { overwriteRoutes: false })
  ...
  describe("sortTask", () => {
    it("when response is ok - sort task asyncly", (done) => {
      ...
      fetchMock.putOnce("*", newTask.toJS(), { overwriteRoutes: false })
  ...
  describe("removeTask", () => {
    it("when response is ok - remove task asyncly", (done) => {
      ...
      fetchMock.deleteOnce("*", {}, { overwriteRoutes: false })
  ...
  describe("doneTask", () => {
    it("mark task asyncly", (done) => {
      ...
      fetchMock.putOnce("*", {}, { overwriteRoutes: false })
